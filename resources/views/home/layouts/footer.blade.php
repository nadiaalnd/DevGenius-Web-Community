        ...
        <div class="-mx-4 flex flex-wrap">
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#activity" class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">
                                Activity
                            </a>
                        </li>
                        <li>
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <ul>
                        <li>
                            <a href="#" class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">
                                How it works
                            </a>
                        </li>
                        <li>
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <ul>
                        <li>
                            <a href="/forum" class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">
                                Forum
                            </a>
                        </li>
                        <li>
            ...
            <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
                <div class="mb-10 w-full">
                    ...
                    <ul class="flex flex-wrap items-center">
                        <li>
                            <a href="#" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="/assets/images/footer/brands/penswhite.png" alt="pens" style="max-width: 70px;" />
                            </a>
                        </li>
                        <li>
                            <a href="#" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="/assets/images/footer/brands/logo-white.png" alt="decant" style="max-width: 70px;" />
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="w-full px-4 md:w-2/3 lg:w-1/2">
                    <div class="my-1">
                        <div class="-mx-3 flex items-center justify-center md:justify-start">
                            <a href="#" class="px-3 text-base text-[#f3f4fe] hover:text-primary">
                                Privacy policy
                            </a>
                            <a href="#" class="px-3 text-base text-[#f3f4fe] hover:text-primary">
                                Legal notice
                ...
                <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                    <div class="my-1 flex justify-center md:justify-end">
                        <p class="text-base text-[#f3f4fe]">
                            ...
                            <a href="#" rel="nofollow noopner" target="_blank" class="text-primary hover:underline">
                                Nadila Aulya
                            </a>
                        </p>
                    </div>
