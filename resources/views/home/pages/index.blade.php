        ...
        <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    ...
                    <p class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed">
                        Unlock your tech potential with DevGenius
                        <br>
                        Be part of our collaborative community for learning, creativity, and innovation
                    </p>
                    <div class="mb-10 flex flex-wrap items-center justify-center">
                        <a href="#" class="inline-flex items-center justify-center rounded-lg bg-white py-4 px-6 text-center text-base font-medium text-dark transition duration-300 ease-in-out hover:text-primary hover:shadow-lg sm:px-10">
                            <span class="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512" class="discord">
                                    <style>
                                        .discord {
                                            fill: #3056d3
                                        }
            ...
            <div class="w-full px-4">
                <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                    <div class="mt-16">
                        <img src="assets/images/hero/hero.png" alt="hero" class="mx-auto max-w-full rounded-t-xl rounded-tr-xl" />
                    </div>
...
<section id="program" class="pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]">
    <div class="container">
        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
                    ...
                    <p class="mb-8 text-body-color lg:mb-11">
                        Seminar online yang memberikan berbagai macam pengetahuan baru di dunia IT.
                    </p>
                </div>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".15s">
                    ...
                    <p class="mb-8 text-body-color lg:mb-11">
                        Pembekalan pengetahuan teknis dan non-teknis membangun sebuah product dari requirement hingga develop.
                    </p>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
                    ...
                    <p class="mb-8 text-body-color lg:mb-11">
                        Brainstorming dan eksekusi ide hingga menjadi produk prototype dengan metode design sprint.
                    </p>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".25s">
                    ...
                    <p class="mb-8 text-body-color lg:mb-11">
                        1:1 feedback untuk hasil validasi MVP dari para mentor dari bidang produk, UI/UX, dan developer.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="w-full px-4">
                    <div class="items-center justify-between overflow-hidden border lg:flex">
                        <div class="w-full py-12 px-7 sm:px-12 md:p-16 lg:max-w-[565px] lg:py-9 lg:px-16 xl:max-w-[640px] xl:p-[70px]">
                            ...
                            <a href="/about" class="inline-flex items-center justify-center rounded bg-primary py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-90 hover:shadow-lg">
                                Learn More
                            </a>
                        </div>
...
<section id="activity" class="relative z-20 overflow-hidden bg-white pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
    <div class="container">
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                    <h2 class="mb-4 text-3xl font-bold text-primary sm:text-4xl md:text-[40px]">
                        Our Activity
                    </h2>
                </div>
            </div>
        ...
        <div class="flex flex-wrap items-center justify-center">
            <div class="w-full md:w-1/2 lg:w-1/3">
                <div class="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-xl border border-primary border-opacity-20 bg-white py-10 px-8 text-center shadow-activity sm:p-12 lg:py-10 lg:px-6 xl:p-12" data-wow-delay=".15s
              ">
                    ...
                    <div class="mb-10">
                        <img src="assets/images/activity/workshop.jpg" alt="">
                    </div>
            ...
            <div class="w-full md:w-1/2 lg:w-1/3">
              ...
              ">
                    ...
                    <div class="mb-10">
                        <img src="assets/images/activity/ignition.jpg" alt="" style="max-width: 342px;">
                    </div>
                    <span class="absolute left-0 bottom-0 z-[-1] block h-14 w-14 rounded-tr-full bg-primary">
                    </span>
                </div>
            ...
            <div class="w-full md:w-1/2 lg:w-1/3">
              ...
              ">
                    ...
                    <div class="mb-10">
                        <img src="assets/images/activity/gathering.jpeg" alt="">
                    </div>
                    <span class="absolute left-0 bottom-0 z-[-1] block h-14 w-14 rounded-tr-full bg-primary">
                    </span>
                </div>
                    ...
                    <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                        ...
                        <div class="mb-8 flex w-[330px] max-w-full">
                            ...
                            <div>
                                ...
                                <p class="text-base text-body-color">info@devgenius.com</p>
                                <p class="text-base text-body-color">
              ...
              ">
                    ...
                    <form>
                        <div class="mb-6">
                            ...
                            <input type="text" name="fullName" placeholder="Nadila Aulya" class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="phone" placeholder="+6281 2545 2115" class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                        </div>
                        <div class="mb-6">
