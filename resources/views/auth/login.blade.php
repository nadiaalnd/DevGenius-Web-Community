        ...
        <div class="container">
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-14 px-8 sm:px-12 md:px-[60px]" data-wow-delay=".15s">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-6">
                                <input id="password" type="password" name="password" required autocomplete="current-password" placeholder="Password" class="@error('password') is-invalid @enderror bordder-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none transition focus:border-primary focus-visible:shadow-none">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <p class="text-center text-base text-dark hover:text-primary">
                        ...
                        <p class="text-center text-base text-[#adadad]">
                            Not a member yet?
